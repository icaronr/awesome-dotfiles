...
beautiful.init("/home/icaro/.config/awesome/themes/rice/theme.lua")
beautiful.icon_theme        = "Papirus"
beautiful.bg_normal         = "#141A1B"
beautiful.bg_focus          = "#222B2E"
beautiful.font              = "Hasklug Nerd Font Mono 12"
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey }, "p", function() xrandr.xrandr() end,
              {description = "xrandr display", group = "xrandr"}),
    -- ALSA volume control
    awful.key({ }, "XF86AudioRaiseVolume",
        function ()
            os.execute(string.format("amixer -q set %s 2%%+", "Master"))
         end,
